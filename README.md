...
```code
# ~/ros2_ws/src/talker_multi_single_threaded_py/talker_multi_single_threaded_py/talker_multi_single_threaded.py
import rclpy
from rclpy.node import Node
...
entry_points={
    'console_scripts': [
        'talker_multi_single_threaded = talker_multi_single_threaded_py.talker_multi_single_threaded:main',
    ],
},
```
